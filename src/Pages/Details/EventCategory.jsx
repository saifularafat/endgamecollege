            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-6 pt-12">
                {
                    eventFind.map((events, index) =>
                        <div
                            key={index}
                        >
                            <div className="space-y-1 md:pb-6 pb-3 hover:shadow-xl shadow-sm p-4 h-full">                                <img src={events?.cultural_img} alt="" className="md:w-[380px] sm:w-[320px] w-full md:h-[280px] sm:h-[220px] " />
